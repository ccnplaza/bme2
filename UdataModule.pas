...
type
  TDataModule1 = class(TDataModule)
    ...
    CHECK_DATA_DEL: TUniStoredProc;
    CHECK_DATA_INS: TUniStoredProc;
    CHECK_DATA_UPD: TUniStoredProc;
    CHECK_DATA_SEL: TUniStoredProc;
    ds_CHECK_DATA_SEL: TDataSource;
    CHECK_DATA_SELID: TIntegerField;
    CHECK_DATA_SELCHECK_DATE: TDateField;
    CHECK_DATA_SELCHASOO: TIntegerField;
    CHECK_DATA_SELMAN_COUNT: TIntegerField;
    ANALYSE_RESULT_DEL: TUniStoredProc;
    ANALYSE_RESULT_IU: TUniStoredProc;
    ANALYSE_RESULT_SEL: TUniStoredProc;
    ds_ANALYSE_RESULT_SEL: TDataSource;
    ANALYSE_RESULT_SELID: TIntegerField;
    ANALYSE_RESULT_SELCHECK_ID: TIntegerField;
    ANALYSE_RESULT_SELSTUDENT_ID: TIntegerField;
    ANALYSE_RESULT_SELPICTURE_ID: TIntegerField;
    ANALYSE_RESULT_SELRESULT1: TIntegerField;
    ANALYSE_RESULT_SELRESULT2: TIntegerField;
    ANALYSE_RESULT_SELRESULT3: TIntegerField;
    ANALYSE_RESULT_SELRESULT4: TIntegerField;
    ...
    CHECK_DATA_SELCENTER_ID: TIntegerField;
    STUDENT_IMAGE_UPD_ID: TUniStoredProc;
    ANALYSE_RESULT_SELRESULT5: TIntegerField;
    ...
    IdHTTP1: TIdHTTP;
    ANALYSE_RESULT_SELRESULT6: TIntegerField;
    ...
    CHECK_DATA_SELCHECK_CNT: TIntegerField;
    ANALYSE_RESULT_CHECK: TUniStoredProc;
    ds_ANALYSE_RESULT_CHECK: TDataSource;
    ANALYSE_RESULT_CHECKID: TIntegerField;
    ANALYSE_RESULT_CHECKCHECK_ID: TIntegerField;
    ANALYSE_RESULT_CHECKSTUDENT_ID: TIntegerField;
    ANALYSE_RESULT_CHECKPICTURE_ID: TIntegerField;
    ANALYSE_RESULT_CHECKS_NAME: TWideStringField;
    ANALYSE_RESULT_CHECKS_SEX: TIntegerField;
    ANALYSE_RESULT_CHECKS_AGE: TIntegerField;
    ANALYSE_RESULT_CHECKCHECK_DONE: TSmallintField;
    ANALYSE_RESULT_CHECKRESULT1: TIntegerField;
    ANALYSE_RESULT_CHECKRESULT2: TIntegerField;
    ANALYSE_RESULT_CHECKRESULT3: TIntegerField;
    ANALYSE_RESULT_CHECKRESULT4: TIntegerField;
